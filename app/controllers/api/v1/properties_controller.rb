  ...
  module V1
    class PropertiesController < ApplicationController
      ...
      def index
        ...
        render json: PropertySerializer.new(@properties, include: [:features, :locality]).serializable_hash
      end

      # GET /api/v1/properties/1
      def show
        render json: PropertySerializer.new(@property, include: [:features, :locality]).serializable_hash
      end
